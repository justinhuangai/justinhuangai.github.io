...
Seq2Seq 證明了端到端翻譯可行，也留下了一個硬瓶頸：整句必須被壓進一個固定向量。[《Neural Machine Translation by Jointly Learning to Align and Translate》](/papers/1409.0473v7.pdf) 的第一性意義，是把「記住整句」改成「每一步重新查找相關資訊」。
