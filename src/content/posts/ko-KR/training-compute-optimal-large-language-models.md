...
Chinchilla가 반박한 것은 scale이 효과적인가가 아닙니다. 고정된 compute 예산에서 scale을 어떻게 나눠야 하는가였습니다. 2022년의 많은 대형 모델은 비용을 주로 파라미터에 썼고, 데이터는 같은 비율로 늘리지 않았습니다. 문제는 모델이 작아서가 아니라 충분히 학습되지 않았다는 데 있었습니다.
