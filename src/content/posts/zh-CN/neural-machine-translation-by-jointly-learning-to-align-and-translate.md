...
Seq2Seq 证明了端到端翻译可行，也留下了一个硬瓶颈：整句必须被压进一个固定向量。[《Neural Machine Translation by Jointly Learning to Align and Translate》](/papers/1409.0473v7.pdf) 的第一性意义，是把“记住整句”改成“每一步重新查找相关信息”。
