---
title: Clawdbot：连接所有聊天渠道的自托管 AI Agent
...
从代码库看，它不是一个小项目：二十多万行 TypeScript，覆盖 macOS、iOS、Android 三端原生应用，外加 50 多个技能模块。
...
所以 Clawdbot 值得关注，不只是因为它是一个手艺很好的开源项目，更因为它代表了一种很少见、但越来越重要的方向：
